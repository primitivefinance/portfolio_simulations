...
def main():
    ...
    if args.type == 'statistical':
        ...
        visualization.plot_all(simulation_data, 'combined_plot_single.png', start_index=0, end_index=20000)#start_index=18530, end_index=18535)#start_index=18572, end_index=18578)
