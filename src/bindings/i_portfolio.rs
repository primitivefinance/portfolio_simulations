...
pub mod i_portfolio {
    ...
    impl<M> ::core::fmt::Debug for IPortfolio<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IPortfolio)).field(&self.address()).finish()
        }
    }
    ...
    impl ::core::convert::From<DefaultStrategyCall> for IPortfolioCalls {
        fn from(value: DefaultStrategyCall) -> Self {
            Self::DefaultStrategy(value)
        }
    }
    impl ::core::convert::From<PositionRendererCall> for IPortfolioCalls {
    ...
    impl ::core::convert::From<GetSpotPriceCall> for IPortfolioCalls {
    ...
    impl ::core::convert::From<ProtocolFeeCall> for IPortfolioCalls {
        fn from(value: ProtocolFeeCall) -> Self {
            Self::ProtocolFee(value)
        }
    }
    impl ::core::convert::From<ProtocolFeesCall> for IPortfolioCalls {
