...
pub mod atomic_arb {
    ...
    pub static ATOMICARB_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static ATOMICARB_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static ATOMICARB_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for AtomicArb<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AtomicArb))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for AtomicArb<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for AtomicArbCalls {
        fn decode(
            ...
            if let Ok(decoded) = <ExecuteXToYCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ExecuteXToY(decoded));
            }
            if let Ok(decoded) = <ExecuteYToXCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for AtomicArbCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::ExecuteXToY(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ExecuteYToX(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
