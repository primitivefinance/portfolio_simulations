pub use i_portfolio_accounting::*;
...
pub mod i_portfolio_accounting {
    ...
    pub static IPORTFOLIOACCOUNTING_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IPortfolioAccounting<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IPortfolioAccounting<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IPortfolioAccounting<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IPortfolioAccounting<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IPortfolioAccounting<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IPortfolioAccounting))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IPortfolioAccounting<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    IPORTFOLIOACCOUNTING_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    pub enum IPortfolioAccountingCalls {
        GetNetBalance(GetNetBalanceCall),
        GetReserve(GetReserveCall),
    }
    impl ::ethers::core::abi::AbiDecode for IPortfolioAccountingCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IPortfolioAccountingCalls {
    ...
    impl ::core::fmt::Display for IPortfolioAccountingCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<GetNetBalanceCall> for IPortfolioAccountingCalls {
        fn from(value: GetNetBalanceCall) -> Self {
            Self::GetNetBalance(value)
        }
    }
    impl ::core::convert::From<GetReserveCall> for IPortfolioAccountingCalls {
